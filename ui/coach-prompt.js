...
## Flags
[Anything the user should verify, watch out for, or do before sending — e.g. "verify the customer story before naming the company," "don't send to jobs@," "this is borderline length, consider cutting paragraph 2"]
`;
