...
export const PRINCIPLES = [
  ...
  {
    category: 'Dealing with reporters (Sorkin)',
    source: 'Andrew Ross Sorkin (NYT DealBook) + Kramon class',
    items: [
      'Never say "no comment." There is always something better, even if you can\'t say much. "I want to give you a real answer, can I call you back at 4?" beats "no comment" every time.',
      'Don\'t avoid calls. Bad feelings compound. Taking the call gives you the chance to understand what the reporter is actually after.',
      'Know the journalist. Read their last six pieces. Talk to peers they\'ve quoted. Build relationships with key journalists before you need them, not during the crisis.',
      'Address the question and tell the truth, but hedge when you must. "Based on what we know today" is the right frame. Avoid overpromising: "It won\'t happen again" and "We assure you our system is safe" age badly.',
      'Focus on the positive, the constructive — what you\'re doing to improve the situation. "I\'m not at liberty to disclose" sounds defensive; "Here\'s what we\'re doing right now" sounds proactive.',
      'Talk in sound bites that make for good quotes. Three sentences that stand alone. If you don\'t write the quote, they will.',
      'Avoid self-incriminating language. "We should have been more careful," "We did not take action early enough," "It was our fault" all sound like character and all read as admissions in court. (See the Tylenol/Kramon counter-school below.)',
      'Avoid "as I said" and "as I mentioned." Sounds impatient and defensive even when you\'re being patient.',
      'Be specific, not vague. "Extremely costly" unnerves investors more than "at least $100 million." A real number is a ceiling; vague language is the reader\'s imagination.',
      'Never sound angry or defensive, even when you feel it. The recording will outlast the moment.',
      'The Tylenol/Kramon counter-school: when reputation risk dominates litigation risk (Johnson & Johnson 1982), own the lapse plainly. When litigation risk dominates (Equifax 2017), hedge without lying. The right answer depends on the situation; name which school you\'re using as a decision, not a default.',
      'AP attribution: on the record (quote by name, default) / off the record (cannot publish) / background (publish with negotiated conditions, usually anonymous with role description) / deep background (publish with no attribution at all). Set the ground rules explicitly before the interview.',
    ],
  },
  {
    category: 'Yourself story (Bryant)',
    source: 'Adam Bryant (NYT Corner Office) + Lauren Weinstein + the six Kramon model bios',
    items: [
      'Bryant\'s rule: "Make the CEO want to have a beer with you AND hire you." Roughly 50/50 word-count split between warmth and competence.',
      'Weinstein\'s research: warmth and competence account for more than 90% of the first impression. The bio is the first impression you control.',
      'Be vivid. Picture your favorite movie scene; describe it in words. That is the texture you want in a bio — sensory detail, a named place, a moment, not summary.',
      'Quotes enliven a story. A line of dialogue from your mother, mentor, or boss the day you got fired is a free dose of warmth.',
      'Humor is non-negotiable (Kramon class rule). Dry, not slapstick. The line that makes the reader smile is the difference between memorable and forgettable.',
      'CEOs prefer "we" over "I" (Bryant, 500-CEO finding). When asked about accomplishments, "we" signals team player, "I" signals self-credit.',
      'Happy endings beat unresolved trouble. Show yourself overcoming, not still mired. The trouble can be real and named, but the close has to land where the reader can root for you.',
      'Tell the messiest situation and what you learned (Roizen). The messy story shows judgment in a way the success story can\'t. "And what you learned" is the load-bearing clause.',
      'Pick a lane. One story told fully beats five told shallowly. (See pick-a-lane skill.)',
      'End with what you\'re still curious about, not a victory lap. The strongest bios close with a question or a frontier.',
      'Six structural patterns from class examples: open in scene then arc back, provocative thesis then evidence, alliterative opening (high-risk), childhood frame, aspiration declared early, sensory open. Pick the one that fits your material.',
      'Wall of shame to cut: "passionate about complex problems," "at the intersection of strategy / product / execution," "I\'m left brain and right brain," "I build and scale to maximize impact." Bryant\'s candidates who used these were the ones he didn\'t hire.',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      'The rule: one story, told fully. Not five stories, each told shallowly. "Pick a lane, and stay in it" — Adam Bryant.',
      'Three failure shapes: the career-arc dump (five jobs in one sentence), the skill-collection dump (five claims, zero evidence), the story-soup (five anecdotes, each two sentences).',
